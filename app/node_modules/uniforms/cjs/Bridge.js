...
class Bridge {
    ...
    constructor(...args) {
        invariant_1.default(this.constructor !== Bridge, 'Bridge cannot be instantiated (args=%o).', { args });
    }
    ...
    getValidator(options) {
        return invariant_1.default(false, '%s have not implemented `getValidator` method (args=%o).', this.constructor.name, { options });
    }
}
