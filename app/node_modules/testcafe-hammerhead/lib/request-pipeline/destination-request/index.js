...
class DestinationRequest extends events_1.EventEmitter {
    ...
    _shouldResendWithCredentials(res) {
        if (res.statusCode === 401 && this.opts.credentials) {
            const authInfo = (0, auth_credentials_1.getAuthInfo)(res);
    ...
    _resendWithCredentials(res) {
        ...
        (0, auth_credentials_1.addCredentials)(this.opts.credentials, this.opts, res, this.protocolInterface);
        ...
        this._send((0, auth_credentials_1.requiresResBody)(res));
    }
    _fatalError(msg, url) {
        if (!this.aborted) {
            this.aborted = true;
