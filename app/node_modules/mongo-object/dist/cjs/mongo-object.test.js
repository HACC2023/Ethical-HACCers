...
describe('MongoObject', () => {
    it('round trip', () => {
        ...
        function passthru(doc) {
            const mDoc = new mongo_object_js_1.default(doc);
    ...
    it('typed arrays', () => {
        const mo = new mongo_object_js_1.default({ foo: new Uint8Array(10) });
    ...
    it('forEachNode', () => {
        const mo = new mongo_object_js_1.default({ foo: 'k', length: 5 });
        // We must use non-dot-notation to access private prop and keep TypeScript happy
        // eslint-disable-next-line dot-notation
        // @ts-expect-error private access for testing
    ...
    it('_keyToPosition', () => {
        ...
        function convert(key, wrapAll, exp) {
            ...
            // eslint-disable-next-line dot-notation
            // @ts-expect-error private access for testing
            const pos = mongo_object_js_1.default._keyToPosition(key, wrapAll);
    ...
    it('makeKeyGeneric', () => {
        function testMakeKeyGeneric(input, expectedOutput) {
            const generic = mongo_object_js_1.default.makeKeyGeneric(input);
    ...
    it('docToModifier', () => {
        ...
        let mod = mongo_object_js_1.default.docToModifier(testObj, {
            keepArrays: true,
        ...
        mod = mongo_object_js_1.default.docToModifier(testObj, {
            keepArrays: true,
    ...
    it('expandObj', () => {
        function testExpandObj(val, exp) {
            const mod = mongo_object_js_1.default.expandObj(val);
